...
local nodes = {
	...
	["iron_glass"] = {
		...
		tiles = {"default_glass.png^[colorize:#DEDEDE"},
		paramtype = "light",
	...
	["coal_glass"] = {
		...
		drawtype = "glasslike_framed_optional",
		tiles = {"default_glass.png^[colorize:#828282"},
		paramtype = "light",
		sunlight_propagates = true,
		is_ground_content = false,
		groups = {cracky = 3, oddly_breakable_by_hand = 3},
	...
	["glow_glass"] = {
		...
		drawtype = "glasslike_framed_optional",
		tiles = {"default_glass.png^[colorize:#E9CD61"},
		paramtype = "light",
		sunlight_propagates = true,
		is_ground_content = false,
		light_source = 11,
	...
	["trap_glow_glass"] = {
		...
		drawtype = "glasslike_framed_optional",
		tiles = {"default_glass.png^[colorize:#E9CD61^moreblocks_trap_box_glass.png"},
		paramtype = "light",
		sunlight_propagates = true,
		is_ground_content = false,
		light_source = 11,
	...
	["trap_super_glow_glass"] = {
		...
		drawtype = "glasslike_framed_optional",
		tiles = {"default_glass.png^[colorize:#FFFF78^moreblocks_trap_box_glass.png"},
		paramtype = "light",
		sunlight_propagates = true,
		is_ground_content = false,
		light_source = default.LIGHT_MAX,
